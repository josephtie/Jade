...
/**
 * REST controller for managing {@link com.ashergadiel.manage.domain.Produit}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Produit> partialUpdateProduit(
        ...
        Optional<Produit> result = produitRepository
            ...
            .map(existingProduit -> {
                ...
                if (produit.getStockinit() != null) {
                    existingProduit.setStockinit(produit.getStockinit());
                }
                if (produit.getStockApprov() != null) {
                    existingProduit.setStockApprov(produit.getStockApprov());
                }
                if (produit.getBoissonPrixUnitairenet() != null) {
                    existingProduit.setBoissonPrixUnitairenet(produit.getBoissonPrixUnitairenet());
                }
