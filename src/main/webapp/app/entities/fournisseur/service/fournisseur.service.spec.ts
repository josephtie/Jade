...
describe('Fournisseur Service', () => {
  ...
  beforeEach(() => {
    ...
    elemDefault = {
      id: 0,
      codeFournisseur: 'AAAAAAA',
      raisonFournisseur: 'AAAAAAA',
      adrfournisseur: 'AAAAAAA',
      paysFournisseur: 'AAAAAAA',
      villeFournisseur: 'AAAAAAA',
      mailFournisseur: 'AAAAAAA',
      celFournisseur: 'AAAAAAA',
      telFournisseur: 'AAAAAAA',
    };
  });
      ...
      const returnedFromService = Object.assign(
        {
          ...
          raisonFournisseur: 'BBBBBB',
          adrfournisseur: 'BBBBBB',
          paysFournisseur: 'BBBBBB',
          villeFournisseur: 'BBBBBB',
          mailFournisseur: 'BBBBBB',
          celFournisseur: 'BBBBBB',
          telFournisseur: 'BBBBBB',
        },
        elemDefault
      );
